...
def main():
        ...
        print(dij)
        print("HEHHEHEHEHEHEHHEHEHEEEEEEEEEEEEEEEEEEEEEEEEE")
        for _ in range(2):              
                ...
                ###################################
                #interger parameters
                Pk =[1000,350]                            #capacity of vehicle k
                Ck =[0,1]                               #cost of vehicle k per unit distance
                Vk =[40000,10]                             #velocity of a vehcle k
                Dij =dij                                #distance between any pair of node i,j 
                P = 120000                                 #price of a burger
                Qi = qi                                 #burger demand of a node
                T = 300000000000000                                 # maximum total travel time 
                ...
                time constriant
                '''
                m.addConstr(quicksum(X[i,j]*Dij[i,j] for i in range(n)for j in range(n))<=T*Vk[_])
                '''
